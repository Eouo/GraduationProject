	...
	<div id="login-container">
		...
		<div id="login-content" class="clearfix">
			...
			<form class="form-inline" method="post" id="loginForm"
				...
				<label> <input class="radio-inline" id="type"
					name="RadioList" type="radio" value="1" checked />用户
				</label> <label> <input class="radio-inline" id="type"
					name="RadioList" type="radio" value="0" />管理员
				</label>
				...
				<div class="end-a">
					<label> <a href="#" onclick="add();">还没注册？马上注册</a>
					</label>
				</div>
			</form>
		</div>
